...
global.apikey = {'https://api.adithyan.m': 'free'}
global.apiUrl = 'https://apli.adithyan.ml/'
...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || 'S⨳H⨳A⨳D⨳O⨳W',
    ...
    BOT_INFO: process.env.BOT_INFO || 'S⨳H⨳A⨳D⨳O⨳W;M⊶R⊶.⊶H⊶A⊶N⊶S⊶A⊶M⊶A⊶L⊶A;94740203415;https://i.imgur.com/6oRG106.jpeg',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'S⨳H⨳A⨳D⨳O⨳W;M⊶R⊶.⊶H⊶A⊶N⊶S⊶A⊶M⊶A⊶L⊶A;https://i.imgur.com/fj2WE83.jpeg' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'S⨳H⨳A⨳D⨳O⨳W;M⊶R⊶.⊶H⊶A⊶N⊶S⊶A⊶M⊶A⊶L⊶A' : process.env.STICKER_DATA,
    ...
    HEROKU: {
       ...
       SUDO: process.env.SUDO || '94740203415,0',
       DEBUG: DEBUG
};
